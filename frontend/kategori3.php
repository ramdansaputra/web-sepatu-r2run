...
<head>
    ...
    <title>Football Shoes - Nike</title>
...
<body>
    ...
    <div class="product-page">
        ...
        <section class="video-section">
            <iframe width="100%" height="550" src="https://www.youtube.com/embed/B5jqZSzZwu8?si=oJ1ekFR10mTTc8Xe" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </section>
        ...
        <div class="product-grid">
            <?php if ($result && $result->num_rows > 0) : ?>
                ...
                <?php endwhile; ?>
            <?php else : ?>
                <p>Tidak ada produk untuk kategori Football Shoes.</p>
            <?php endif; ?>
        </div>
    </div>
